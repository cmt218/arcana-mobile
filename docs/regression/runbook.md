...
| Want | Command |
|---|---|
| Full pre-release pass | no `--tier` (all 263) |
...
For every **Source:** path listed across all 263 inventory entries, verify
...
should yield **184 unique paths from 771 comma-split tokens across 268 Source
...
it was 166 / 728 / 264 before that); earlier the same day (`fix/sentry-corrupt-report-preflight`
...
across CLASS-08, CLASS-18, CLASS-27 and DEVSET-12; it was 113 / 585 / 241
before that); earlier the same day (Task 5 of phase 4's
tactile pass, `feature/polish-2-navigation`, cited `theme/AppColors.kt`,
`ui/Depth.kt`, `ui/StudioAccordion.kt`, `ui/FilterChip.kt` and
`theme/Motion.kt` for the first time anywhere in the inventory — spread across
DEVSET-12, ERR-01, ERR-03, SCHED-09, SCHED-10, SCHED-11, SCHED-13, SEARCH-02,
SEARCH-03 and PLAT-11 among 25 entries whose Expected was rewritten in place
for the new press/depth feedback and the decision-H `PaperTranslucent` token;
it was 108 / 569 / 241 before that, since the pass added no new entry);
earlier the same day (after `feature/polish-3-schedule-pager`
added SCHED-21/SCHED-22 and cited `schedule/DayRail.kt`, `schedule/DayPage.kt`
and `ui/Shimmer.kt` for the first time anywhere in the inventory, on
SCHED-03/04/05/06/12/13/18/21/22 and ERR-03; it was 105 / 559 / 239 before
that, since that branch added exactly two new entries); earlier, 2026-09-06
(after `feature/polish-2-navigation` cited `theme/NavTransitions.kt`,
`ui/ArcanaSheet.kt` and `ui/Transient.kt` on CLASS-01/08/14/18, NAV-01,
DEVSET-12, ERR-02/05/21, PROFILE-05 and SCHED-12; it was 102 / 545 / 239
before that, since that branch rewrote entries in place and added no new
entry); earlier the same day, after PLAT-12 landed, it was
102 / 545 / 239 (96 / 538 / 238 before that); earlier 2026-08-11, 2026-08-15, 2026-08-16 (after
