...
// The iOS deep-link bridge (IosDeepLinkBridge + onIosDeepLink) lives in
// :sharedLogic iosMain (navigation/IosDeepLinkBridge.kt). Swift calls it as
// IosDeepLinkBridgeKt.onIosDeepLink(url:).
