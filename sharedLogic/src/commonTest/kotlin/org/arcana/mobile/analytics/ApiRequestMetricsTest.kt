...
class ApiRequestMetricsTest {
    ...
    @Test fun `every endpoint mapping is locked`() {
        val expected = mapOf(
            ...
            ("POST" to "/api/v1/bookings/55/review/") to "review_create",
            ("PATCH" to "/api/v1/bookings/55/review/") to "review_update",
            ("POST" to "/api/v1/bookings/55/review/dismiss/") to "review_dismiss",
            ("GET" to "/api/v1/reviews/") to "feedback_feed",
