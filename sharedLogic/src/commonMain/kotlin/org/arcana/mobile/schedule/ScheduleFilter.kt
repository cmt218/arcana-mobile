 ...
 */
fun expandSelectionToLocationIds(
...
fun customTimeLabel(startGte: String?, startLte: String?): String = when {
...
fun customTimeFilter(startGte: String?, startLte: String?): TimeFilter =
...
const val TIME_SLIDER_MIN_GAP_MINUTES = 60
