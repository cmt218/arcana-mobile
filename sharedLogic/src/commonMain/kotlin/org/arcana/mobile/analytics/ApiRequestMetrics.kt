...
fun normalizeEndpoint(method: String, encodedPath: String): String {
    ...
    return when (m to shape) {
        ...
        "POST" to "bookings/{id}/review" -> "review_create"
        "PATCH" to "bookings/{id}/review" -> "review_update"
        "POST" to "bookings/{id}/review/dismiss" -> "review_dismiss"
        "GET" to "reviews" -> "feedback_feed"
